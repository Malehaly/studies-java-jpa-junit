...
public class ManterCliente {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Digite: \n S - Para Salvar um cliente"
						...
						+ "\n LS - Para listar os clientes por nome"
		...
		case "L":
			...
			break;
		case "LS":
			System.out.println("Digite o nome do cliente para a lista");
			String s = LER.next();
			listaClientes(s);
			break;
		case "D":
	...
	private static void listaClientes(String nome) {

		ClienteRepository cli = new ClienteRepository(fabrica);
		List<Cliente> clientes = cli.getClientes(nome);
		System.out.println("Os clientes que tem nome "
				+ nome + " são:");
		for (Cliente c : clientes) {
...
*/
		...
		Cliente cliente2 = new Cliente("424441", "Carlos", tel1,	end1, "98552144000101");
